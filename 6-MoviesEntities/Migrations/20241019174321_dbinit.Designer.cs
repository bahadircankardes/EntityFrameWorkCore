...
namespace _6_MoviesEntities.Migrations
{
    ...
    [Migration("20241019174321_dbinit")]
            ...
            modelBuilder.Entity("_6_MoviesEntities.Entities.Concrete.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "Drama",
                            CreateDate = new DateTime(2024, 10, 19, 20, 43, 20, 848, DateTimeKind.Local).AddTicks(8630),
                            Description = "Drama"
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "Sci-Fi",
                            CreateDate = new DateTime(2024, 10, 19, 20, 43, 20, 848, DateTimeKind.Local).AddTicks(8680),
                            Description = "Sci-Fi"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("_6_MoviesEntities.Entities.Concrete.Week", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 10, 19, 20, 43, 20, 852, DateTimeKind.Local).AddTicks(1800),
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 10, 19, 20, 43, 20, 852, DateTimeKind.Local).AddTicks(1840),
                            EndDate = new DateOnly(2025, 8, 14),
                            StartDate = new DateOnly(2023, 8, 14),
                            WeekName = "W33"
                        },
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2024, 10, 19, 20, 43, 20, 852, DateTimeKind.Local).AddTicks(1850),
                            EndDate = new DateOnly(2025, 8, 14),
                            StartDate = new DateOnly(2023, 8, 14),
                            WeekName = "W34"
                        });
