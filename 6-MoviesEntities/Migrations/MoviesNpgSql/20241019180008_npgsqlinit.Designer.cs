...
namespace _6_MoviesEntities.Migrations.MoviesNpgSql
{
    ...
    [Migration("20241019180008_npgsqlinit")]
    partial class npgsqlinit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("_6_MoviesEntities.Entities.Concrete.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "Drama",
                            CreateDate = new DateTime(2024, 10, 19, 21, 0, 7, 816, DateTimeKind.Local).AddTicks(9260),
                            Description = "Drama"
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "Sci-Fi",
                            CreateDate = new DateTime(2024, 10, 19, 21, 0, 7, 816, DateTimeKind.Local).AddTicks(9300),
                            Description = "Sci-Fi"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = 5,
                            CategoryName = "Crime",
                            CreateDate = new DateTime(2024, 10, 19, 21, 0, 7, 816, DateTimeKind.Local).AddTicks(9310),
                            Description = "Crime"
                        });
                });
            ...
            modelBuilder.Entity("_6_MoviesEntities.Entities.Concrete.Week", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 10, 19, 21, 0, 7, 820, DateTimeKind.Local).AddTicks(5380),
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 10, 19, 21, 0, 7, 820, DateTimeKind.Local).AddTicks(5420),
                            EndDate = new DateOnly(2025, 8, 14),
                            StartDate = new DateOnly(2023, 8, 14),
                            WeekName = "W33"
                        },
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2024, 10, 19, 21, 0, 7, 820, DateTimeKind.Local).AddTicks(5430),
                            EndDate = new DateOnly(2025, 8, 14),
                            StartDate = new DateOnly(2023, 8, 14),
                            WeekName = "W34"
                        });
