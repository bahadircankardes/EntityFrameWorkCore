...
namespace _6_MoviesEntities.Migrations.MoviesNpgSql
{
    ...
    [Migration("20241019180911_npgsqlsecond")]
    partial class npgsqlsecond
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("_6_MoviesEntities.Entities.Concrete.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "Drama",
                            CreateDate = new DateTime(2024, 10, 19, 21, 9, 11, 114, DateTimeKind.Local).AddTicks(4620),
                            Description = "Drama"
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "Sci-Fi",
                            CreateDate = new DateTime(2024, 10, 19, 21, 9, 11, 114, DateTimeKind.Local).AddTicks(4630),
                            Description = "Sci-Fi"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 10, 19, 21, 9, 11, 114, DateTimeKind.Local).AddTicks(4640),
            ...
            modelBuilder.Entity("_6_MoviesEntities.Entities.Concrete.Week", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 10, 19, 21, 9, 11, 117, DateTimeKind.Local).AddTicks(6010),
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 10, 19, 21, 9, 11, 117, DateTimeKind.Local).AddTicks(6020),
                            EndDate = new DateOnly(2025, 8, 14),
                            StartDate = new DateOnly(2023, 8, 14),
                            WeekName = "W33"
                        },
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2024, 10, 19, 21, 9, 11, 117, DateTimeKind.Local).AddTicks(6030),
                            EndDate = new DateOnly(2025, 8, 14),
                            StartDate = new DateOnly(2023, 8, 14),
                            WeekName = "W34"
                        });
