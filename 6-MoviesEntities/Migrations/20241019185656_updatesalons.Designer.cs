...
namespace _6_MoviesEntities.Migrations
{
    ...
    [Migration("20241019185656_updatesalons")]
    partial class updatesalons
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("_6_MoviesEntities.Entities.Concrete.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "Drama",
                            CreateDate = new DateTime(2024, 10, 19, 18, 56, 56, 232, DateTimeKind.Utc).AddTicks(2410),
                            Description = "Drama"
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "Sci-Fi",
                            CreateDate = new DateTime(2024, 10, 19, 18, 56, 56, 232, DateTimeKind.Utc).AddTicks(2420),
                            Description = "Sci-Fi"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 10, 19, 18, 56, 56, 232, DateTimeKind.Utc).AddTicks(2430),
            ...
            modelBuilder.Entity("_6_MoviesEntities.Entities.Concrete.Saloon", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2024, 10, 19, 21, 56, 56, 234, DateTimeKind.Utc).AddTicks(9060),
                            Kapasite = (short)50,
                            SalonName = "C Salonu"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 10, 19, 21, 56, 56, 234, DateTimeKind.Utc).AddTicks(9130),
                            Kapasite = (short)150,
                            SalonName = "B Salonu"
                        });
                });
            ...
            modelBuilder.Entity("_6_MoviesEntities.Entities.Concrete.Week", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 10, 19, 21, 56, 56, 238, DateTimeKind.Local).AddTicks(6000),
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 10, 19, 21, 56, 56, 238, DateTimeKind.Local).AddTicks(6020),
                            EndDate = new DateOnly(2025, 8, 14),
                            StartDate = new DateOnly(2023, 8, 14),
                            WeekName = "W33"
                        },
